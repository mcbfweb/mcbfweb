...
<%
	...
	'------------------------------------
	*/
	//gv_APIUserName	= "mycityfind@outlook.com";
	// TEST
	//gv_APIPassword	= "Select#1a";
	//gv_APISignature = "";
	
	
	//PROD
	gv_APIUserName = "mycityfind_api1.outlook.com";
	gv_APIPassword	= "U2M5SQNKSV7YUD2U";
	gv_APISignature = "A5jLajrmbltEwLtrQ1vPYjh186C7ASx1ESjcQYbNTZdL.bTYLND0mUKN";
	
	//SANDBOX
	gv_APIUserName = "mycityfind_api1.outlook.com";
	gv_APIPassword	= "1404620696";
	gv_APISignature = "Av-8jKadCQ9X2mF55Lm2AtT7UaRTAvTZpwU4nVX0g0zusUHPpTV-VjW8";
